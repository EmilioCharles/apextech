                    ...
                    {projects.map((project, idx) => (
                        ...
                        >
                            ...
                            <div className="relative mb-16 max-w-5xl mx-auto flex flex-col md:flex-row items-end justify-center">
                                ...
                                <div className="absolute right-0 -bottom-12 md:-right-2 md:-bottom-6 w-[25%] md:w-[20%] z-20 transform group-hover:translate-x-2 transition-transform duration-500">
                                    <PhoneMockup>
                                        <img
