...
const projects = [
    {
        ...
        repoUrl: "#",
        liveUrl: "https://neoninsurance.com",
        desktopImg: "/project-neon.png",
        mobileImg: "/project-neon.png"
    },
    {
        title: "FreshSaver",
    ...
    },
    {
        ...
        repoUrl: "#",
        liveUrl: "https://nsharaexpedition.com",
        desktopImg: "/project-nshara.png",
        mobileImg: "/project-nshara.png"
    }
];
                    ...
                    {projects.map((project, idx) => (
                        ...
                        >
                            ...
                            <div className="relative mb-16 max-w-5xl mx-auto flex flex-col md:flex-row items-end justify-center">
                                ...
                                {/* Phone - Overlapping */}
                                <div className="hidden md:block absolute -right-4 -bottom-4 w-[20%] z-20 transform group-hover:translate-x-2 transition-transform duration-500">
                                    <PhoneMockup>
                                        <img
